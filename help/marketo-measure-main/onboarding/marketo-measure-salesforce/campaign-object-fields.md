...
description: In questa lezione vengono illustrati i campi dell'oggetto Campaign di Salesforce CRM che [!DNL Marketo Measure] utilizza per mappare campagne e membri della campagna ai canali di marketing. È importante comprendere il funzionamento di questi oggetti della campagna durante la gestione e la mappatura dei canali offline in [!DNL Marketo Measure].
role: User
level: Beginner
